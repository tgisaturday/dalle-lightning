...
class VQGAN(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx, optimizer_idx):     
        ...
        if optimizer_idx == 0:
            ...
            self.log("train/ae_loss", aeloss, prog_bar=True, logger=False, on_step=True, on_epoch=True)
        ...
        if optimizer_idx == 1:
            ...
            discloss, log_dict_disc = self.loss(qloss, x, xrec, optimizer_idx, self.global_step,
                                            last_layer=self.get_last_layer(), split="train")
            self.log("train/dis_closs", discloss, prog_bar=True,logger=False, on_step=True, on_epoch=True)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log("val/ae_loss", aeloss, prog_bar=True, logger=False, on_step=True, on_epoch=True)
